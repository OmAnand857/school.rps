            ...
            <>
                    ...
                    <img  class="object-contain absolute top-[-1.75vw] left-[7.75vw] h-[10vw] w-[10vw] "src="./scribble final version-145.png" alt=""></img>
                        ...
                        <div class="flex flex-col items-center w-4/5">
                            ...
                            <p class="text-[1.50vw] font-[Roboto]">"Dive into our gallery of past activities to witness the vibrant tapestry of our school's dynamic spirit. Each snapshot captures the essence of creativity, collaboration, and joy, showcasing the boundless potential of our young learners."</p>
