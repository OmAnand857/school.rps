    ...
    },
    {
        ...
        return (    
            ...
            <div className='flex  text-white gap-[3vw] mt-[2vw]'><button className="bg-[#1B7242] p-[1vw] rounded">Get Started</button> <button className="bg-transparent border-white border-2 p-[1vw] rounded">Watch Video</button></div>
                    ...
                    <img className=" scroll-opacity hidden lg:block absolute top-[8%] h-[10vw] w-[18vw] left-[20%] object-contain" src="./Group 14.png" alt=""></img>
                            <div className="pinanimate flex flex-col items-center">
                    ...
                    <img   className="scroll-opacity hidden lg:block object-contain absolute top-[3.5vw] left-[65vw] h-[10vw] w-[10vw] "src="./Group 9.png" alt=""></img>
                            <h1  className="textanimate text-[#1B7242] text-center lg:my-[2vw] my-[4vw] text-6xl leading-[150%] tracking-wide font-[Outfit] font-semibold">DIRECTORS MESSAGE</h1>
