            ...
            <div class='flex  text-white gap-[3vw] mt-[2vw]'><button class="bg-[#1B7242] p-[1vw] rounded">Get Started</button> <button class="bg-transparent border-white border-2 p-[1vw] rounded">Watch Video</button></div>
                    ...
                    <img class="hidden lg:block absolute top-[8%] h-[10vw] w-[18vw] left-[20%] object-contain" src="./Group 14.png" alt=""></img>
                            <div class="flex flex-col items-center">
                                ...
                                <div class="lg:flex-row flex flex-col items-center w-4/5 lg:gap-4 gap-[4vw]">
                                    ...
                                    <div class="scroll-animate-rev lg:w-2/4 w-full "><img src="https://static.vecteezy.com/system/resources/thumbnails/007/343/251/small_2x/school-building-in-flat-style-modern-school-college-building-illustration-vector.jpg" alt=""/></div>
                                </div>
                            </div>
                    </div>
                    ...
                    <img   class=" hidden lg:block object-contain absolute top-[3.5vw] left-[65vw] h-[10vw] w-[10vw] "src="./Group 9.png" alt=""></img>
                            ...
                            <div class="flex lg:flex-row flex-col  gap-[4vw] lg:gap-4 items-center w-4/5">
                                <div class=" scroll-animate lg:w-2/4 w-full " >
                    ...
                    <img   class="scroll-plane object-contain absolute top-[-1.75vw] left-[7.75vw] h-[10vw] w-[10vw] "src="./scribble final version-145.png" alt=""></img>
