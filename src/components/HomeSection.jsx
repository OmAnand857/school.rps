        ...
        return (    
            <>              
                        ...
                        <div>
                                ...
                                <div  class=" w-[80vw] lg:w-[40vw] absolute top-[30%] left-[15%] translate-y-[-50%]">
                                    ...
                                    <div class='flex  text-white gap-[3vw]'><button class="bg-[#1B7242] p-[1vw] rounded">Get Started</button> <button class="bg-transparent border-white border-2 p-[1vw] rounded">Watch Video</button></div>
                                    
                                </div>

                                <div class=" hidden lg:flex h-[40vh] w-[65vw]  absolute bottom-[-20%] left-[50%] translate-x-[-50%]  justify-around">

                                            <div class="flex flex-col items-center justify-around w-[30%] h-full shadow">
                    ...
                    <img class="hidden lg:block absolute top-[8%] h-[10vw] w-[18vw] left-[20%] object-contain" src="./Group 14.png" alt=""></img>
                            <div class="flex flex-col items-center">
                                ...
                                <div class="lg:flex-row flex flex-col items-center w-4/5 lg:gap-0 gap-[4vw]">
                                    <div class="lg:w-2/4 w-full h-full flex flex-col justify-center items-center">
